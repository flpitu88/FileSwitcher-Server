...
public class ServicioTransmision {
    ...
    public Object recibirMje() throws IOException {
        return this.oisRecep.read();
    }
    
    public void enviarMje(Serializable mje) throws IOException {
        this.oosEnvio.writeObject(mje);
    }
}
